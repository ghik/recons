...
import com.github.ghik.recons.server.utils.Environment
 ...
 *                      [[com.github.ghik.recons.server.utils.ShellExtensions ShellExtensions]]
 *                      in the REPL
 */
...
object ReplConfig {
  ...
  final val DefaultWelcome = {
    ...
    s"""Welcome to Recons, based on Scala $ScalaVersion (Java $JavaVersion, $JavaVmName).
       |Type in expressions for evaluation. Or try :help.
       |""".stripMargin
  }

  final val DefaultPrompt = "recons> "
}
